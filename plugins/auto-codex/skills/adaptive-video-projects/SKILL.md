...
description: Reusable workflow for video editing, short-form clips, subtitles, thumbnails, timelines, social media cuts, batch rendering, ffmpeg automation, and creative post-production projects that should adaptively learn via Auto Codex.
---
...
6. After a style, template, or platform workflow repeats, invoke Auto Codex to create or patch a project-specific video skill.
...
If video work repeats for a channel, campaign, creator, product, or platform, use `$auto-codex` to learn the house style and render workflow into a project-level skill.
